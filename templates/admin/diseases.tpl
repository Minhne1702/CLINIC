        ...
        <tr>
          ...
          <td>
            <div class="table-actions">
              ...
              <a href="/CLINIC/public/?role=admin&page=diseases&action=delete&id={$d._id}" class="action-btn action-btn--danger" title="Xóa" onclick="return confirm('Xóa bệnh này?')"><i class="fa-solid fa-trash"></i></a>
            </div>
          </td>
        </tr>
        {foreachelse}
