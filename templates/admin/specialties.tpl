        ...
        <tr>
          ...
          <td>
            <div class="table-actions">
              ...
              <a href="/CLINIC/public/?role=admin&page=specialties&action=toggle&id={$spec._id}" class="action-btn" title="Bật/Tắt"><i class="fa-solid fa-power-off"></i></a>
              <a href="/CLINIC/public/?role=admin&page=specialties&action=delete&id={$spec._id}" class="action-btn action-btn--danger" title="Xóa" onclick="return confirm('Xóa chuyên khoa này?')"><i class="fa-solid fa-trash"></i></a>
            </div>
          </td>
        </tr>
        {foreachelse}
