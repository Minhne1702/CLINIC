        ...
        <tr>
          ...
          <td>
            <div class="table-actions">
              <a href="/CLINIC/public/?role=admin&page=users&action=edit&id={$u._id}" class="action-btn" title="Sửa"><i class="fa-solid fa-pen"></i></a>
              <a href="/CLINIC/public/?role=admin&page=users&action=toggle&id={$u._id}" class="action-btn" title="Bật/Tắt"><i class="fa-solid fa-power-off"></i></a>
              <a href="/CLINIC/public/?role=admin&page=users&action=delete&id={$u._id}" class="action-btn action-btn--danger" title="Xóa" onclick="return confirm('Xóa tài khoản này?')"><i class="fa-solid fa-trash"></i></a>
            </div>
          </td>
        </tr>
        {foreachelse}
