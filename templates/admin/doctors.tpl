        ...
        <tr>
          ...
          <td>
            <div class="table-actions">
              <a href="/CLINIC/public/?role=admin&page=doctors&action=view&id={$doc._id}" class="action-btn" title="Xem"><i class="fa-solid fa-eye"></i></a>
              <a href="/CLINIC/public/?role=admin&page=doctors&action=edit&id={$doc._id}" class="action-btn" title="Sửa"><i class="fa-solid fa-pen"></i></a>
              <a href="/CLINIC/public/?role=admin&page=doctors&action=schedule&id={$doc._id}" class="action-btn" title="Lịch làm"><i class="fa-regular fa-calendar"></i></a>
              <a href="/CLINIC/public/?role=admin&page=doctors&action=delete&id={$doc._id}" class="action-btn action-btn--danger" title="Xóa" onclick="return confirm('Xóa bác sĩ này?')"><i class="fa-solid fa-trash"></i></a>
            </div>
          </td>
        </tr>
        {foreachelse}
