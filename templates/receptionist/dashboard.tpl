...
<div class="patient-welcome" style="background:linear-gradient(135deg,#065f46 0%,#10b981 100%)">
  ...
  <a href="/CLINIC/public/?role=receptionist&page=checkin" class="btn-admin-primary" style="background:#fff;color:#065f46">
...
<div class="dashboard-grid">
  <div class="admin-card admin-card--lg">
    <div class="admin-card__header"><h3><i class="fa-solid fa-list-ol"></i> Hàng chờ hiện tại</h3><a href="/CLINIC/public/?role=receptionist&page=queue" class="btn-link">Xem đầy đủ</a></div>
  ...
  <div class="admin-card">
    <div class="admin-card__header"><h3><i class="fa-solid fa-calendar-check"></i> Lịch hẹn sắp tới</h3><a href="/CLINIC/public/?role=receptionist&page=appointments" class="btn-link">Xem tất cả</a></div>
    <div class="admin-card__body p-0">
