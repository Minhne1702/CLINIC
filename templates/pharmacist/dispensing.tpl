...
<div class="page-toolbar">
  ...
  <div class="page-toolbar__right"><a href="/CLINIC/public/?role=pharmacist&page=prescriptions" class="btn-admin-ghost"><i class="fa-solid fa-arrow-left"></i> Danh sách đơn</a></div>
</div>
...
<div class="billing-layout">
  ...
  <div class="admin-card admin-card--lg">
    ...
    <div class="admin-card__footer">
      <form action="/CLINIC/public/" method="POST">
...
<div class="empty-state admin-card" style="padding:3rem">
  ...
  <a href="/CLINIC/public/?role=pharmacist&page=prescriptions" class="btn-admin-primary" style="margin-top:1rem">Xem danh sách đơn thuốc</a>
</div>
{/if}
