...
<div class="patient-welcome" style="background:linear-gradient(135deg,#4c1d95 0%,#8b5cf6 100%)">
  ...
  <a href="/CLINIC/public/?role=pharmacist&page=prescriptions" class="btn-admin-primary" style="background:#fff;color:#4c1d95">
...
<div class="alert alert--warning mb-1"><i class="fa-solid fa-triangle-exclamation"></i> Có <strong>{$stats.low_stock}</strong> loại thuốc sắp hết hàng. <a href="/CLINIC/public/?role=pharmacist&page=low-stock">Xem ngay →</a></div>
{/if}

<div class="dashboard-grid">
  <div class="admin-card admin-card--lg">
    <div class="admin-card__header"><h3><i class="fa-solid fa-prescription"></i> Đơn thuốc mới nhất</h3><a href="/CLINIC/public/?role=pharmacist&page=prescriptions" class="btn-link">Xem tất cả</a></div>
      ...
      <table class="admin-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="/CLINIC/public/?role=pharmacist&page=dispensing&id={$rx._id}" class="btn-admin-primary" style="font-size:12px;padding:.35rem .75rem"><i class="fa-solid fa-capsules"></i> Phát thuốc</a></td>
          </tr>
  ...
  <div class="admin-card">
    <div class="admin-card__header"><h3><i class="fa-solid fa-boxes-stacking"></i> Tồn kho thấp</h3><a href="/CLINIC/public/?role=pharmacist&page=low-stock" class="btn-link">Xem tất cả</a></div>
    <div class="admin-card__body p-0">
