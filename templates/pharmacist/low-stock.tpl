...
<div class="page-toolbar">
  ...
  <div class="page-toolbar__right"><a href="{$base_url}/?role=pharmacist&page=stock-in" class="btn-admin-primary"><i class="fa-solid fa-truck-ramp-box"></i> Nhập kho ngay</a></div>
</div>
  ...
  <table class="admin-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="{$base_url}/?role=pharmacist&page=stock-in&drug_id={$drug._id}" class="btn-admin-primary" style="font-size:12px;padding:.35rem .75rem"><i class="fa-solid fa-plus"></i> Nhập thêm</a></td>
      </tr>
