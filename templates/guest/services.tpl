...
<section class="section section--light" style="padding-top:2rem;padding-bottom:2rem">
  <div class="container">
    <div class="service-tabs">
      ...
      <a href="{$BASE_URL}/?page=services" class="service-tab {if $cur_cat == ''}active{/if}">Tất cả</a>
      <a href="{$BASE_URL}/?page=services&amp;cat=kham" class="service-tab {if $cur_cat == 'kham'}active{/if}">Khám bệnh</a>
      <a href="{$BASE_URL}/?page=services&amp;cat=xet-nghiem" class="service-tab {if $cur_cat == 'xet-nghiem'}active{/if}">Xét nghiệm</a>
      <a href="{$BASE_URL}/?page=services&amp;cat=phau-thuat" class="service-tab {if $cur_cat == 'phau-thuat'}active{/if}">Phẫu thuật</a>
      <a href="{$BASE_URL}/?page=services&amp;cat=nha-khoa" class="service-tab {if $cur_cat == 'nha-khoa'}active{/if}">Nha khoa</a>
      <a href="{$BASE_URL}/?page=services&amp;cat=tu-xa" class="service-tab {if $cur_cat == 'tu-xa'}active{/if}">Khám từ xa</a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="services-full-grid" data-animate="stagger">
      ...
      <div class="service-full-card">
        ...
        <a href="{$BASE_URL}/?page=appointments&amp;service={$svc.id}" class="btn-book-sm" style="align-self:center;white-space:nowrap;padding:.6rem 1.2rem">
          Đặt lịch
        </a>
      </div>
      {/foreach}
    ...
    <div class="services-full-grid" data-animate="stagger">
      <div class="service-full-card">
        ...
        <a href="{$BASE_URL}/?page=appointments" class="btn-book-sm" style="align-self:center;white-space:nowrap;padding:.6rem 1.2rem">Đặt lịch</a>
      </div>
      <div class="service-full-card">
...
<section class="cta-banner">
  <div class="container cta-banner__inner">
    ...
    <div class="cta-banner__actions">
      <a href="{$BASE_URL}/?page=contact" class="btn-cta-primary"><i class="fa-solid fa-phone"></i> Tư vấn miễn phí</a>
    </div>
  </div>
</section>
