    ...
    <div class="auth-form-wrap" data-animate="fade-left">
      <div class="form-card">
        <div class="form-card__header">
          <h2>Đăng nhập</h2>
          <p>Chưa có tài khoản? <a href="{$BASE_URL}/?page=register">Đăng ký ngay</a></p>
        </div>
        ...
        <form action="{$BASE_URL}/?page=login" method="POST" class="appt-form">
          ...
          <div class="form-group">
            <label>
              ...
              <a href="{$BASE_URL}/?page=forgot-password" class="label-link">Quên mật khẩu?</a>
            </label>
            <div class="input-icon-wrap">
