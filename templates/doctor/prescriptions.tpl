...
<div class="admin-card mb-1"><div class="admin-card__body">
  <form method="GET" action="/CLINIC/public/" class="filter-bar"><input type="hidden" name="role" value="doctor"><input type="hidden" name="page" value="prescriptions">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><div class="table-actions">
        <a href="/CLINIC/public/?role=doctor&page=prescriptions&id={$rx._id}" class="action-btn" title="Xem chi tiết"><i class="fa-solid fa-eye"></i></a>
      </div></td>
    </tr>
