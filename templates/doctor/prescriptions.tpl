    ...
    <form method="GET" action="{$BASE_URL}/" class="filter-bar">
      ...
      <div class="filter-bar__group">
        <div class="filter-input">
          ...
          <input type="text" name="q" placeholder="Tên bệnh nhân, mã đơn..." value="{$filter.q|default:''}">
        </div>
    ...
    <table class="admin-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            {* Đã fix lại logic kiểm tra trạng thái khớp với CSDL *}
            {if $rx.status == 'done'}
              <span class="badge badge--success"><i class="fa-solid fa-check"></i> Đã phát</span>
            {elseif $rx.status == 'paid'}
          ...
          <td>
            <div class="table-actions">
              <a href="{$BASE_URL}/?role=doctor&page=prescriptions&id={$rx._id}" class="action-btn" title="Xem chi tiết">
