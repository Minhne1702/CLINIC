    ...
    <div class="queue-col__body" id="col-waiting">
      ...
      <div class="queue-card queue-card--{$q.priority|default:'normal'}" data-status="waiting">
        ...
        <div class="queue-card__actions">
          <a href="/CLINIC/public/?role=doctor&page=examination&patient_id={$q.patient_id}&queue_id={$q._id}" class="btn-admin-primary" style="font-size:12px;padding:.4rem .85rem;white-space:nowrap">
  ...
  <div class="queue-col">
    ...
    <div class="queue-col__body" id="col-progress">
      ...
      <div class="queue-card queue-card--active" data-status="in_progress">
        ...
        <div class="queue-card__actions">
          <a href="/CLINIC/public/?role=doctor&page=examination&patient_id={$q.patient_id}&queue_id={$q._id}" class="btn-admin-secondary" style="font-size:12px;padding:.4rem .85rem">
  ...
  <div class="queue-col">
    ...
    <div class="queue-col__body" id="col-done">
      ...
      <div class="queue-card queue-card--done" data-status="done">
        ...
        <a href="/CLINIC/public/?role=doctor&page=records&patient_id={$q.patient_id}" class="action-btn" title="Xem hồ sơ"><i class="fa-solid fa-eye"></i></a>
      </div>
      {/if}
      {/foreach}
    </div>
