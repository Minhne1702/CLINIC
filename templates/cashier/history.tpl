...
<div class="page-toolbar">
  ...
  <div class="page-toolbar__right">
    <a href="/CLINIC/public/?role=cashier&page=history&action=export" class="btn-admin-secondary"><i class="fa-solid fa-file-excel"></i> Xuất Excel</a>
  </div>
</div>
<div class="admin-card mb-1"><div class="admin-card__body">
  <form method="GET" action="/CLINIC/public/" class="filter-bar"><input type="hidden" name="role" value="cashier"><input type="hidden" name="page" value="history">
...
<div class="admin-card"><div class="admin-card__body p-0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/CLINIC/public/?role=cashier&page=history&id={$bill._id}" class="action-btn" title="Xem & In"><i class="fa-solid fa-print"></i></a></td>
    </tr>
