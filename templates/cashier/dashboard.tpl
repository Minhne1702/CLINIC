...
<div class="patient-welcome" style="background:linear-gradient(135deg,#92400e 0%,#f59e0b 100%)">
  ...
  <a href="/CLINIC/public/?role=cashier&page=billing" class="btn-admin-primary" style="background:#fff;color:#92400e">
...
<div class="dashboard-grid">
  <div class="admin-card admin-card--lg">
    <div class="admin-card__header"><h3><i class="fa-solid fa-clock"></i> Chờ thanh toán</h3><a href="/CLINIC/public/?role=cashier&page=pending" class="btn-link">Xem tất cả</a></div>
      ...
      <table class="admin-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="/CLINIC/public/?role=cashier&page=billing&id={$bill._id}" class="btn-admin-primary" style="font-size:12px;padding:.35rem .8rem"><i class="fa-solid fa-cash-register"></i> Thanh toán</a></td>
          </tr>
