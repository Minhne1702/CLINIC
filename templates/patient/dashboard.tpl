{include file="layout/header.tpl" page_title="Tổng quan" active_page="dashboard"}
...
<div class="patient-welcome">
  ...
  <a href="/CLINIC/public/?role=patient&page=book" class="patient-welcome__btn">
...
<div class="dashboard-grid">
  ...
  <div class="admin-card admin-card--lg">
    <div class="admin-card__header">
      ...
      <a href="/CLINIC/public/?role=patient&page=appointments" class="btn-link">Xem tất cả</a>
    </div>
  ...
  <div class="admin-card">
    <div class="admin-card__header">
      ...
      <a href="/CLINIC/public/?role=patient&page=records" class="btn-link">Xem tất cả</a>
    </div>
    <div class="admin-card__body p-0">
      {if $recent_records}
...
<div class="admin-card" style="margin-top:1rem">
  <div class="admin-card__header">
    ...
    <a href="/CLINIC/public/?role=patient&page=notifications" class="btn-link">Xem tất cả</a>
  </div>
  <div class="admin-card__body p-0">
