<?php
/* Smarty version 5.8.0, created on 2026-04-06 05:40:52
  from 'file:admin/appointments.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69d32b4482cd88_98786435',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '98a529453010fb0afbda2aa2f26a92a794c2e8c2' => 
    array (
...
function content_69d32b4482cd88_98786435 (\Smarty\Template $_smarty_tpl) {
...
<div class="status-tabs mb-1">
  ...
  <a href="/CLINIC/public/?role=admin&page=appointments" class="status-tab <?php if ($_smarty_tpl->getValue('cur_status') == '') {?>active<?php }?>">
    Tất cả <span class="tab-count"><?php echo (($tmp = $_smarty_tpl->getValue('count')['all'] ?? null)===null||$tmp==='' ? 0 ?? null : $tmp);?>
</span>
  </a>
  <a href="/CLINIC/public/?role=admin&page=appointments&status=pending" class="status-tab <?php if ($_smarty_tpl->getValue('cur_status') == 'pending') {?>active<?php }?>">
  ...
  <a href="/CLINIC/public/?role=admin&page=appointments&status=confirmed" class="status-tab <?php if ($_smarty_tpl->getValue('cur_status') == 'confirmed') {?>active<?php }?>">
  ...
  <a href="/CLINIC/public/?role=admin&page=appointments&status=completed" class="status-tab <?php if ($_smarty_tpl->getValue('cur_status') == 'completed') {?>active<?php }?>">
  ...
  <a href="/CLINIC/public/?role=admin&page=appointments&status=cancelled" class="status-tab <?php if ($_smarty_tpl->getValue('cur_status') == 'cancelled') {?>active<?php }?>">
        ...
        <tr>
          ...
          <td>
            <div class="table-actions">
              <a href="/CLINIC/public/?role=admin&page=appointments&action=view&id=<?php echo $_smarty_tpl->getValue('apt')['_id'];?>
" class="action-btn" title="Xem"><i class="fa-solid fa-eye"></i></a>
              <?php if ($_smarty_tpl->getValue('apt')['status'] == 'pending') {?>
              <a href="/CLINIC/public/?role=admin&page=appointments&action=confirm&id=<?php echo $_smarty_tpl->getValue('apt')['_id'];?>
" class="action-btn action-btn--success" title="Xác nhận"><i class="fa-solid fa-check"></i></a>
              <?php }?>
              <a href="/CLINIC/public/?role=admin&page=appointments&action=cancel&id=<?php echo $_smarty_tpl->getValue('apt')['_id'];?>
