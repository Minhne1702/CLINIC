<?php
/* Smarty version 5.8.0, created on 2026-04-09 08:24:00
  from 'file:admin/patients.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69d76220ab2330_52359607',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '145e4ec14428ebf03ed629cfd8bd26cc14b96482' => 
    array (
...
function content_69d76220ab2330_52359607 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\Users\\THANH TRI\\CLINIC\\templates\\admin';
...
/?role=admin&page=patients&action=create" class="btn-admin-primary">
...
">
        ...
        <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=patients" class="btn-admin-ghost">Xóa lọc</a>
      </div>
    </form>
  </div>
</div>
        ...
        <tr>
          ...
          <td>
            <div class="table-actions">
              <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=patients&action=view&id=<?php echo $_smarty_tpl->getValue('p')['_id'];?>
" class="action-btn" title="Xem hồ sơ"><i class="fa-solid fa-folder-open"></i></a>
              <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=patients&action=edit&id=<?php echo $_smarty_tpl->getValue('p')['_id'];?>
" class="action-btn" title="Sửa"><i class="fa-solid fa-pen"></i></a>
              <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=patients&action=history&id=<?php echo $_smarty_tpl->getValue('p')['_id'];?>
" class="action-btn" title="Lịch sử khám"><i class="fa-solid fa-clock-rotate-left"></i></a>
              <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=patients&action=delete&id=<?php echo $_smarty_tpl->getValue('p')['_id'];?>
