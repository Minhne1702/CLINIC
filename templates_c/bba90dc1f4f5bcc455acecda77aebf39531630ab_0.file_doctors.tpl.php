<?php
/* Smarty version 5.8.0, created on 2026-04-09 08:54:11
  from 'file:admin/doctors.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_69d7693346ef23_26651947',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bba90dc1f4f5bcc455acecda77aebf39531630ab' => 
    array (
      0 => 'admin/doctors.tpl',
      1 => 1775610517,
      2 => 'file',
...
function content_69d7693346ef23_26651947 (\Smarty\Template $_smarty_tpl) {
...
/?role=admin&page=doctors&action=create" class="btn-admin-primary">
...
echo $_smarty_tpl->getSmarty()->getModifierCallback('truncate')($_smarty_tpl->getValue('doc')['full_name'],1,'');
          ...
          <td>
            <div class="table-actions">
              <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=doctors&action=view&id=<?php echo $_smarty_tpl->getValue('doc')['_id'];?>
" class="action-btn" title="Xem"><i class="fa-solid fa-eye"></i></a>
              <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=doctors&action=edit&id=<?php echo $_smarty_tpl->getValue('doc')['_id'];?>
" class="action-btn" title="Sửa"><i class="fa-solid fa-pen"></i></a>
              <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=doctors&action=schedule&id=<?php echo $_smarty_tpl->getValue('doc')['_id'];?>
" class="action-btn" title="Lịch làm"><i class="fa-regular fa-calendar"></i></a>
              <a href="<?php echo $_smarty_tpl->getValue('BASE_URL');?>
/?role=admin&page=doctors&action=delete&id=<?php echo $_smarty_tpl->getValue('doc')['_id'];?>
