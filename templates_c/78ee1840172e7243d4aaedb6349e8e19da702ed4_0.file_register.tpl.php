  ...
  <div class="auth-container">
    <div class="auth-brand" data-animate="fade-right">
      <div class="auth-brand__logo">
        <div class="logo-icon" style="width:56px;height:56px;font-size:24px"><i class="fa-solid fa-heart-pulse"></i>
        </div>
      ...
      <div class="auth-features">
        ...
        <div class="auth-feature"><i class="fa-solid fa-shield-halved"></i><span>Thông tin bảo mật tuyệt đối</span>
        </div>
      </div>
    </div>
...
">
          ...
          <div class="form-group" id="otp_group" style="display: none;">
            <label>Mã xác thực OTP <span class="required">*</span></label>
            <div class="input-group-wrapper" style="display: flex; gap: 10px; align-items: center;">
              <div class="input-icon-wrap" style="flex: 1;">
                <i class="fa-solid fa-key"></i>
                <input type="text" name="otp" placeholder="Nhập 6 số" maxlength="6">
              </div>
              <div class="resend-wrap">
                <button type="button" id="btn_resend_otp" disabled
                  style="background: none; border: none; color: #007bff; cursor: pointer; font-size: 14px;">
                  Gửi lại mã <span id="timer"></span>
                </button>
              </div>
            </div>
            <small class="form-text text-muted">Vui lòng kiểm tra hòm thư của bạn.</small>
          </div>
